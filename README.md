...
**特性：**
- ✅ **优先使用上海黄金交易所 AU9999 现货基准价**（国内权威数据）
- ✅ 降级使用 COMEX 黄金期货价格（国际实时数据）
- ✅ 自动换算人民币/克价格
- ✅ 显示涨跌幅和涨跌额
- ✅ 交易时间每小时推送一次
- ✅ 飞书消息推送
...
| 数据源 | 类型 | 更新频率 | 准确性 |
|--------|------|----------|--------|
| SGE (上海黄金交易所) | 现货基准价 | 每日 2 次 (早盘/晚盘) | ⭐⭐⭐⭐⭐ 国内权威 |
| COMEX (腾讯财经) | 期货价格 | 实时 | ⭐⭐⭐⭐ 国际参考 |

> ⚠️ **注意：** COMEX 金价换算后与国内金价可能存在 5-10% 差异，因为期货市场定价机制、汇率波动、税费等因素。优先使用 SGE 数据确保准确性。
